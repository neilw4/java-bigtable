...
public class SimpleLoadTest {
  ...
  private static final int MIN_RUN_DURATION_SECONDS = 40;
  private static final int MIN_REQUESTS = 10_000;
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    String targetQpsString = System.getenv("CBT_TARGET_QPS");
    int targetQps = Integer.parseInt(targetQpsString);

    System.out.println("ts,algorithm,directpath,run_duration_s,threads,target_qps,throughput,mean,p50,p90,p95,p99,errors");
  ...
  private static void runTest(BigtableDataClient client, int targetQps, @Nullable String algorithm, @Nullable String directpath, int runDurationS)
    ...
    log("starting run with QPS " + targetQps + " for " + runDurationS + "s");
